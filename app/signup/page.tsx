...
import { ChefHat, Mail, Lock, User, ArrowRight, AlertCircle, Loader2 } from 'lucide-react';
            ...
            >
                <div className="bg-white/80 backdrop-blur-md rounded-[40px] shadow-soft border border-warm-beige/30 p-8 md:p-12 relative overflow-hidden">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h1 className="font-serif-elegant text-3xl text-dark-brown mb-2">{t('auth.joinHeritage')}</h1>
                        <p className="text-sm text-dark-brown/60 font-medium tracking-wide">{t('auth.preserveSecrets')}</p>
                    </div>
                    ...
                    <div className="mt-10 text-center text-sm text-dark-brown/60">
                        ...
                        <Link href="/login" className="text-olive-green font-bold hover:text-terracotta transition-colors underline underline-offset-4">
                            {t('auth.signIn')}
                        </Link>
                    </div>
                </div>
